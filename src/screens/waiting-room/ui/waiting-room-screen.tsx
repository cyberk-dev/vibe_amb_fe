...
export function WaitingRoomScreen() {
  const { seats, maxSeats, isRoomFull, countdown } = useWaitingRoomFlow();

  return <WaitingRoom seats={seats} maxSeats={maxSeats} countdown={countdown} isCountdownActive={isRoomFull} />;
}
