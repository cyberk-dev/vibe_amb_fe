 ...
 * - 20 seats grid display with actual player names
 * - Placeholder seats for empty positions
...
export function WaitingRoomScreen() {
  const { seats, maxSeats, isCountdownActive, countdown } = useWaitingRoomFlow();

  return <WaitingRoom seats={seats} maxSeats={maxSeats} countdown={countdown} isCountdownActive={isCountdownActive} />;
}
