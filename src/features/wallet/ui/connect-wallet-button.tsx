...
// COMMENTED: EVM wallet connection - app now uses Aptos
...
// COMMENTED: EVM ConnectWalletButton - restore when EVM provider is enabled
...
export const ConnectWalletButton: React.FC<Props> = () => {
  // EVM wallet disabled - Aptos wallet is used in admin screen
  return null;
};
