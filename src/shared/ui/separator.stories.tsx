  ...
  render: () => (
    <div className="w-[300px]">
      <div className="space-y-1">
        ...
        <p className="text-sm text-muted-foreground">Some content above the separator</p>
      </div>
      <Separator className="my-4" />
      <div className="space-y-1">
        <h4 className="text-sm font-medium leading-none">Another Section</h4>
        <p className="text-sm text-muted-foreground">Some content below the separator</p>
      </div>
    </div>
  ),
};
...
export const InMenu: Story = {
  render: () => (
    <div className="w-[200px] rounded-md border p-2">
      ...
      <Separator className="my-1" />
      <div className="px-2 py-1.5 text-sm font-medium text-destructive">Delete</div>
    </div>
  ),
};
  ...
  render: () => (
    <div className="w-[400px] space-y-6">
      <section>
        ...
        <p className="text-sm text-muted-foreground mt-2">This is the first section with some content.</p>
      </section>
      <Separator />
      <section>
        <h3 className="text-lg font-semibold">Section 2</h3>
        <p className="text-sm text-muted-foreground mt-2">This is the second section with different content.</p>
      </section>
      <Separator />
      <section>
        <h3 className="text-lg font-semibold">Section 3</h3>
        <p className="text-sm text-muted-foreground mt-2">This is the third section with even more content.</p>
      </section>
    </div>
  ),
};
