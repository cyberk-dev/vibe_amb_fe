...
const simulateAsyncOperation = async (options: MutationOptions = {}): Promise<void> => {
...
export const deleteUserMutation = async (userId: string): Promise<MutationResult<DeleteUserData>> => {
  try {
...
export const uploadFilesMutation = async (files: string[]): Promise<MutationResult<UploadFilesData>> => {
  try {
...
// Payment Actions
export const processPaymentMutation = async (amount: number): Promise<MutationResult<ProcessPaymentData>> => {
  try {
