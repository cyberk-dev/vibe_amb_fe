 ...
 */
export function truncateMiddle(str: string, startChars = 4, endChars = 4, ellipsis = "..."): string {
  if (!str) return str;
...
export const truncateWalletAddress = (walletAddress: string, start = 6, end = 5) => {
