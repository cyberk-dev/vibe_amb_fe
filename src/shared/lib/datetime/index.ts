 ...
 */
export function formatTime(date: Date | string, formatString = "HH:mm"): string {
  try {
    const dateObj = typeof date === "string" ? parseISO(date) : date;
    if (!isValid(dateObj)) return "";
    return format(dateObj, formatString);
 ...
 */
export function formatDateTime(date: Date | string, formatString = "yyyy-MM-dd HH:mm"): string {
  try {
    const dateObj = typeof date === "string" ? parseISO(date) : date;
    if (!isValid(dateObj)) return "";
    return format(dateObj, formatString);
