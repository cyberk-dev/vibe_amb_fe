...
describe("datetime helpers", () => {
  ...
  describe("formatDateTime", () => {
    ...
    it("should format with custom format string", () => {
      expect(formatDateTime(testDate, "yyyy/MM/dd HH:mm:ss")).toBe("2024/03/15 14:30:00");
    });
  ...
  describe("isDateBefore", () => {
    ...
    it("should work with ISO strings", () => {
      expect(isDateBefore("2024-03-10T00:00:00.000Z", "2024-03-20T00:00:00.000Z")).toBe(true);
    });
  });
  ...
  describe("isDateAfter", () => {
    ...
    it("should work with ISO strings", () => {
      expect(isDateAfter("2024-03-20T00:00:00.000Z", "2024-03-10T00:00:00.000Z")).toBe(true);
    });
  });
  ...
  describe("isSameDayAs", () => {
    ...
    it("should work with ISO strings", () => {
      expect(isSameDayAs("2024-03-15T10:00:00.000Z", "2024-03-15T20:00:00.000Z")).toBe(true);
    });
  });
  ...
  describe("getDaysDifference", () => {
    ...
    it("should work with ISO strings", () => {
      expect(getDaysDifference("2024-03-20T00:00:00.000Z", "2024-03-10T00:00:00.000Z")).toBe(10);
    });
  });
  ...
  describe("getHoursDifference", () => {
    ...
    it("should work with ISO strings", () => {
      expect(getHoursDifference("2024-03-15T14:00:00.000Z", "2024-03-15T10:00:00.000Z")).toBe(4);
    });
  });
  ...
  describe("getMinutesDifference", () => {
    ...
    it("should work with ISO strings", () => {
      expect(getMinutesDifference("2024-03-15T14:30:00.000Z", "2024-03-15T14:00:00.000Z")).toBe(30);
    });
  });
